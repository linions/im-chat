...
public class GroupChatOperateReceiver {
    ...
    public void onChatMessage(@Payload Message message,
        ...
        try {
            ...
            }else if (command.equals(GroupEventCommand.GROUP_MSG_ACK.getCommand())) {
                MessageReadContent messageRead = JSON.parseObject(msg, new TypeReference<MessageReadContent>() {}.getType());
